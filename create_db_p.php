...
if(isset($_POST["register"]))
{
  ...
  //   {
  //     echo "id: " . $row["id"]." ". " Name: " . $row["name"]." ". "Email: " . $row["email"]." ". "Requirements: ".$row["toh"]." "."Phone number: ".$row["phonenum"]." "."Address: ".$row["address"].",".$row["city"].",".$row["pin"]." "."Number of people travelling: ".$row["ppl"]."<br>";
  //   }
  // }
