  		...
  		if($pass==$row["pass"])
  		{
  			...
  			if ($result3->num_rows>0) 
  			{
    			while($row=$result3->fetch_assoc())
    			{
      				...
      				if($flag==1)
     				{
        				...
        				echo "<td>".$a."</td>";
        				$a=$a+1;
        				echo "<td id='tableinfo'>"."Name: ".$row["name"]."<br><br>"."Email: ".$row["email"]."<br><br>"."Phone number: ".$row["phonenum"]."<br><br>"."Address: ".$row["address"].",".$row["pin"]."</td>";
        				echo "<td><iframe src=".$row["loc"]." width='300' height='275' style='border:0;' loading='eager'></iframe></td>";
        				echo "</tr>";
      				}
    			}
  			}

  			$sql6="SELECT * FROM hospitals";  
			$result4=$conn->query($sql6);

			echo "<tr><td><br><br></td></tr>";

			echo "<tr><td colspan='2' id='statement'>The following are some of the best hospitals in mumbai for treatment of cancer</td></tr>";
			...
			if ($result4->num_rows> 0) 
			{
			  while($row = $result4->fetch_assoc()) 
			  {
        			...
        			echo "<td>".$b."</td>";
        			$b=$b+1;
        			echo "<td id='tableinfo'>"."Name: ".$row["name"]."<br><br>"."Email: ".$row["email"]."<br><br>"."Sector: ".$row["sec"]."<br><br>"."Phone number: ".$row["phonenum"]."<br><br>"."Address: ".$row["address"].",".$row["pin"]."</td>";
        			echo "</tr>";
			  }
			}
			echo "</table>";
